...
Version  : 1.0
Release  : 14
URL      : https://cran.r-project.org/src/contrib/webutils_1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/webutils_1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566487241
